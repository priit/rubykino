  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved vote as @vote" do
        ...
        post :create, {:vote => { "video_id" => "invalid value" }}, valid_session
        assigns(:vote).should be_a_new(Vote)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested vote" do
        ...
        Vote.any_instance.should_receive(:update_attributes).with({ "video_id" => "1" })
        put :update, {:id => vote.to_param, :vote => { "video_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the vote as @vote" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Vote.any_instance.stub(:save).and_return(false)
        put :update, {:id => vote.to_param, :vote => { "video_id" => "invalid value" }}, valid_session
        assigns(:vote).should eq(vote)
      end
